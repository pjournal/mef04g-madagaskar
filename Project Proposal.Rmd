...
The dataset covers up all the recorded earthquakes in Turkey between 1910 and 2017.This data is obtained from [Kaggle](https://www.kaggle.com/caganseval/earthquake). In the dataset we have 24007 observations with 17 features.
