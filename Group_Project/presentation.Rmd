...
The Rate of Warranty Coverage of Service Expenses Belongs to Model 23
...
kable(plot_8,col.names = c("Model", "Production date", "Total price"))%>%
...
<font size="2"> 
- When filtered according to Model 23, which has the highest service cost, it was seen that the vehicles' service costs with the production year 2016 and 2017 were the two highest models.<br>
- The general warranty period is 3 years, the number of transactions made within the warranty scope in the first 3 years has been high but has become very low after 4 years. After the age of 7, all transactions are made out of warranty.
---
...
![](https://github.com/pjournal/mef04g-madagaskar/blob/gh-pages/Group_Project/Images/shiny.png?raw=true)
